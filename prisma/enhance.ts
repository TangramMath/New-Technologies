...
const outputsInfo = {
  ...
  TeamGroupBy: ["id", "name", "userId", "_count", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UserCountAggregate: ["id", "name", "email", "_all"],
  UserMinAggregate: ["id", "name", "email"],
  UserMaxAggregate: ["id", "name", "email"],
  TeamCountAggregate: ["id", "name", "userId", "_all"],
  TeamMinAggregate: ["id", "name", "userId"],
  TeamMaxAggregate: ["id", "name", "userId"]
};
...
const inputsInfo = {
  ...
  TeamWhereInput: ["AND", "OR", "NOT", "id", "name", "User", "userId"],
  TeamOrderByWithRelationInput: ["id", "name", "User", "userId"],
  TeamWhereUniqueInput: ["id", "userId"],
  TeamOrderByWithAggregationInput: ["id", "name", "userId", "_count", "_max", "_min"],
  TeamScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "userId"],
  ...
  TeamCreateManyInput: ["id", "name", "userId"],
  ...
  TeamCountOrderByAggregateInput: ["id", "name", "userId"],
  TeamMaxOrderByAggregateInput: ["id", "name", "userId"],
  TeamMinOrderByAggregateInput: ["id", "name", "userId"],
  TeamCreateNestedOneWithoutUserInput: ["create", "connectOrCreate", "connect"],
  StringFieldUpdateOperationsInput: ["set"],
  TeamUpdateOneWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  TeamUpsertWithoutUserInput: ["update", "create"],
  ...
  UserUpsertWithoutTeamsInput: ["update", "create"],
